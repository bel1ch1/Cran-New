...
DEFAULT_CAMERA_INTRINSICS: dict[str, dict[str, list[list[float]] | list[float]]] = {
    "camera_0": {
        "camera_matrix": [
            [1777.1736924530028, 0.0, 728.1015127005423],
            [0.0, 1763.3337864872312, 428.470951113461],
            [0.0, 0.0, 1.0],
        ],
        "dist_coeffs": [
            0.4874920591831232,
            -4.367983402103326,
            0.022145267928667087,
            0.005696299528595056,
            16.05682348055553,
        ],
    },
    "camera_1": {
        "camera_matrix": [
            [1722.95671623021, 0.0, 669.761778236129],
            [0.0, 1720.2010099877689, 221.29462190136044],
            [0.0, 0.0, 1.0],
        ],
        "dist_coeffs": [
            0.04521279344827378,
