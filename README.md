...
```bash
/home/cran/cran/venv/bin/python -m pip install -r requirements.txt
/home/cran/cran/venv/bin/python -m uvicorn main:app --reload
```
...
# для того чтобы программа видела пакет picamera2, нужно использовать специальное вирутальное окружение:
```bash
### Создайте НОВОЕ окружение с доступом к системным пакетам
python3 -m venv --system-site-packages /home/cran/cran/venv
```
